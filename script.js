...
{`<img src="https://openweathermap.org/img/wn/${weather.icon}.png" alt="${weather.weather}" style="vertical-align:middle; width: 28px; height: 28px;" />`} ${weather.temperature}<br />
${weather.weather}
