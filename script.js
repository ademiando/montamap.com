...
// Show selected content const sel = document.getElementById(tabName); if (sel) sel.style.display = 'block';
...
// Ensure Community, Gear, News tabs display if (['Community', 'Gear', 'News'].includes(tabName)) { const el = document.getElementById(tabName); if (el) el.style.display = 'block'; } }, 100); } }
